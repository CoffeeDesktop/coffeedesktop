  ...
  main: ->
    "<div id='tabs'>
        ...
        <div id='tabs-2'>
          ...
          <p>This is example:</p>
          <img src='vendors/icons/app.png' desktop_object_options='' desktop_object_run='sa link' desktop_object_fullname='SA Show hidden' desktop_object_icon='app.png' class=' i_wanna_be_a_desktop_object sa_drag_button'>DRAG THIS ON DESKTOP PLIZ
        </div>
        <div id='tabs-3'>
